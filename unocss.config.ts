...
export default defineConfig({
  ...
  safelist: [
    'ant-design:home-outlined', 'ant-design:setting-outlined', 'ant-design:read-outlined', 'codicon:tools', 'ant-design:question-circle-outlined',
    'text-primary',
    'h-10 cursor-pointer !inline-block',
